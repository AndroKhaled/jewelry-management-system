    ...
    public partial class sell : Form
    {
        ...
        private void sell_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "SELECT الكود FROM fmain WHERE [اسم المشتري] IS NULL";
        ...
        private void btnsearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = "SELECT [الكود],[اسم الصنف],[وزن ذهب],[وزن ماس],[اضافه 1],[اضافه 2],[اضافه 3],[اضافه 4],[اضافه 5],[سعر الشراء],[سعر البيع],[الشركة المنتجه],[اسم المشتري],[سعر بيع فعلي],[تاريخ البيع],[ملاحظات],[المكان],[معار],[وصل الاعارة] FROM fmain WHERE [الكود]= '" + txtid.Text + "' ";
                cmd.ExecuteNonQuery();
        ...
        private void btnsell_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand();
                cmd.Connection = con;
                cmd.CommandText = " UPDATE fmain SET [اسم المشتري] = '" + txtname.Text + "', [تاريخ البيع]= '" + dtbuy.Value.Date + "', [سعر بيع فعلي]= '" + sellpp.Text + "' WHERE [الكود]= '" + txtid.Text + "' ";
                cmd.ExecuteNonQuery();
            }
            catch (Exception ex)
            {
